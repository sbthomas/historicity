...
A further supplementary study establishes the baseline rate of
community-sense \grk{adelphos} in contemporary non-Christian Greek by
random sampling across six corpora spanning documentary papyri (100
BCE--70 CE), the Septuagint, Philo of Alexandria, Josephus, and pagan
literary authors both pre-Pauline (Polybius, Diodorus, Strabo) and
contemporary (Plutarch, Epictetus, Dio Chrysostom).  Across 212
randomly-sampled tokens, the community/voluntary-association rate (A)
is \textit{0.9\%} with 95\%~Wilson confidence interval
$[0.3\%,~3.4\%]$.  The comparable Pauline rate is \textit{96.7\%}
($[91.8\%,~98.7\%]$).  The two confidence intervals do not overlap,
and the ratio of the point estimates is approximately $103\times$.
Paul's use of \grk{adelphos} is not ordinary contemporary Greek usage;
it is a distinctive, strongly-marked dialect of early Christian
community discourse.  For a disputed Pauline \grk{adelphos} token such
as Galatians~1:19, the prior expectation about sense should be drawn
from Paul's own corpus-wide distribution (overwhelmingly community),
not from the broader Greek baseline (overwhelmingly biological or
ethnic).  Details of the corpus selection, sampling methodology, per-
bucket statistics, and coding limitations are given in the companion
document \textit{Corpus-Linguistic Baseline for Adelphos in
Contemporary Greek}.
...
%% ============================================================
\section{Mythological Parallels and Prior Sources}
\label{sec:myth}
%% ============================================================

A central claim of this paper is that every narrative element of the
Jesus tradition can be traced to identifiable prior sources---either
Jewish scriptural templates or Hellenistic mythological conventions.
This section catalogs the most important parallels and addresses the
principal historicist objection.

%% ------------------------------------------------------------
\subsection{Dying-and-Rising Gods in the Ancient Mediterranean}
\label{sec:myth:dying}
%% ------------------------------------------------------------

The pattern of a god or divine figure who dies---often violently---and
returns to life, with the death carrying soteriological significance
(salvation, renewal, cosmic restoration), was pervasive in the ancient
Mediterranean and Near East well before the emergence of Christianity.

\citet{Frazer1890} cataloged this pattern extensively in \textit{The
Golden Bough}, identifying it across Mesopotamian (Tammuz/Dumuzi),
Egyptian (Osiris), Phrygian (Attis), Syrian (Adonis), and Greek
(Dionysus, Persephone) traditions.  Frazer was criticized---with some
justice---for overgeneralizing, smoothing over differences between
traditions, and imposing a single interpretive framework.  But the
existence of the pattern itself was confirmed by more careful subsequent
scholarship, notably \citet{Mettinger2001}, whose \textit{The Riddle
of Resurrection} subjected the evidence to rigorous scrutiny and
concluded that dying-and-rising gods are genuinely attested in
pre-Christian sources, contrary to the revisionist claims of
\citet{Smith2005} and others who had argued the category was a modern
scholarly invention.

The specific parallels are instructive:

\begin{itemize}[leftmargin=2em]
\item \textbf{Osiris} is killed (by dismemberment in most versions),
mourned by Isis, reassembled, and resurrected to become lord of the
afterlife.  The Isis-Osiris cult was among the most popular in the
Roman Empire during the first century~BCE and first century~CE, with
temples and initiatory rites across the Mediterranean.  The cult
offered participants a share in Osiris's victory over death---a
soteriological structure closely paralleling the Pauline claim that
believers participate in Christ's death and resurrection
(Romans~6:3--11).

\item \textbf{Attis} dies---in most versions by self-castration or
being killed by a boar---and is reborn.  His cult, centered on the
Magna Mater (Cybele), was officially established in Rome in 204~BCE
and included an annual festival in March commemorating his death and
resurrection.  The ritual included a day of mourning (the ``Day of
Blood'') followed by a celebration of resurrection (the
\textit{Hilaria}).  The structural parallel with the Christian Holy
Week sequence---death on Friday, mourning on Saturday, celebration of
resurrection on Sunday---is striking.

\item \textbf{Dionysus} is the son of a divine father (Zeus) and a
mortal woman (Semele).  He is killed (torn apart by Titans in the
Orphic tradition), resurrected, and becomes a god associated with
wine, ecstatic experience, and the promise of life after death.  His
first miracle in the literary tradition is the transformation of water
into wine at a wedding feast (Euripides, \textit{Bacchae})---the same
miracle attributed to Jesus at Cana (John~2:1--11).

\item \textbf{Adonis} dies annually (gored by a boar) and is mourned
by Aphrodite; his return from the underworld is celebrated in spring
festivals across the Levant and Greece.  The cult was particularly
strong in Syria and the eastern Mediterranean during the Hellenistic
and Roman periods.
\end{itemize}

The historicist response to these parallels takes two forms.  The first
is to deny the parallels themselves, arguing that the differences between
each tradition and Christianity are more significant than the
similarities.  This is true at the level of narrative detail: no single
dying-and-rising god story is identical to the Jesus narrative.  But
the argument misses the point.  The claim is not that Christianity
copied a specific myth wholesale; it is that Christianity drew on a
widely available mythological grammar---a set of narrative patterns,
ritual structures, and soteriological concepts---that provided the raw
materials from which the Jesus narrative could be constructed.

The second response is chronological: some of the clearest parallels
(particularly in the Attis cult) are attested in forms that postdate
Christianity, and may represent pagan borrowing from Christianity rather
than the reverse.  This is a legitimate concern for specific cases, but
it does not address the Egyptian, Mesopotamian, and Greek traditions,
which are attested centuries before Christianity, or the structural
pattern itself, which is not dependent on any single exemplar.

%% ------------------------------------------------------------
\subsection{Hebrew Bible Typology: Isaiah~53, Psalm~22, Wisdom~2--5}
\label{sec:myth:hb}
%% ------------------------------------------------------------
...
%% ------------------------------------------------------------
\subsection{Hellenistic \textit{Theios An\=er} Conventions}
\label{sec:myth:theios}
%% ------------------------------------------------------------

The Greco-Roman literary tradition included a well-established genre of
the \textit{theios an\=er} (``divine man'')---a figure of divine
parentage or divine empowerment who performs miracles, teaches wisdom,
attracts followers, suffers opposition, and is vindicated after death
\citep{Bieler1935,Tiede1972}.  Apollonius of Tyana, Pythagoras, and
Alexander the Great all attracted biographical traditions conforming to
this pattern.

Philostratus's \textit{Life of Apollonius} (written \circa 220~CE but
drawing on earlier traditions) describes a figure who performs healings
and exorcisms, predicts the future, gathers disciples, conflicts with
political authority, is tried and imprisoned, miraculously escapes or
is vindicated, and appears to followers after death.  The parallels with
the Gospel narrative are extensive---not because one tradition borrowed
from the other, but because both draw on the same stock of conventions
for portraying a divine man in Hellenistic literary culture.

The Gospel Jesus conforms to \textit{theios an\=er} conventions in his
miraculous birth, his wisdom teaching, his miracle-working, his
conflict with authorities, his noble death, and his post-mortem
appearances.  This does not prove that Jesus is fictional---historical
figures could be described in these terms---but it means that every
element of the Gospel portrayal can be explained as conventional
literary construction without recourse to historical memory.  The
\textit{theios an\=er} template, like the Hebrew Bible typology, provides
a sufficient source for the narrative.  A historical figure is not
required.
