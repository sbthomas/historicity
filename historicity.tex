...
for the \grk{adelph-} family of compounds Paul uses.  Four words
are relevant: \grk{adelphos} itself, the adjective
\grk{phil-adelphos} (\enquote{brother-loving}), the abstract noun
\grk{philadelphia} (\enquote{brotherly love,} Rom~12:10,
1~Thess~4:9), and the compound noun \grk{pseudadelphos}
(\enquote{false brother,} Gal~2:4, 2~Cor~11:26).

Cambridge includes \grk{adelphos} with an explicit
community/Christian sense (sense 2b, quoted above).  Cambridge
includes \grk{phil-adelphos} (page 1462) but cites only Xenophon,
Plutarch, Sophocles, and Polybius---strictly classical and
Hellenistic literary authors, with no NT citation.  Cambridge does
\textit{not} include the abstract noun \grk{philadelphia} at all,
even though the editors list the parallel abstract noun
\grk{philandria} (\enquote{love of one's husband}) on the same
page.  Cambridge also does \textit{not} include the Pauline
compound \grk{pseudadelphos}, despite listing other NT-specific
\grk{pseudo-} compounds (including \grk{pseudo-proph\=et\=es},
\enquote{false prophet,} cited from NT) on the very same page 1518
where \grk{pseudadelphos} would alphabetically appear.
