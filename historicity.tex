...
A cross-check against Liddell--Scott--Jones \citep{LSJ1940}, the
canonical full-range classical lexicon (which extends centuries
beyond Cambridge's early-second-century terminus), confirms and
refines this picture.  LSJ \textit{does} include all three words
as separate headwords; but the citation ranges it gives tell the
same story Cambridge's editorial selections imply.  For
\grk{philadelphia}, LSJ's cited attestations are Hellenistic-Jewish
(Philo 2.558, Josephus \textit{Antiquities} 2.6.9) and early-Imperial
(Babrius 47.15), alongside the NT; no classical citations are
given.  For \grk{pseudadelphos}, LSJ's entire citation corpus
consists of 2~Cor~11:26, Gal~2:4, and ancient glossaries---the
word is a Pauline hapax in extant Greek outside later glossary
compilations.  For \grk{adelphot\=es}, LSJ cites 4~Macc~9:23 and
10:3, 1~Pet~2:17 and 5:9, and Dio Chrysostom's \textit{Oration}~38
(\enquote{On Concord with the Nicomedians,} c.~100~CE, where Dio
applies the term metaphorically to the political concord of
neighbouring cities)---again an exclusively post-classical
distribution clustering in Hellenistic-Jewish, NT, and early-
Imperial Greek.  The two lexicons therefore agree on the substance.
Cambridge declines to give these three words separate headwords
because they are not part of the classical Greek lexical stratum
its cut-off covers; LSJ, whose chronological sweep is far wider,
records them, but with citation windows that begin no earlier
than the Hellenistic period and are dominated by Hellenistic-Jewish
and early-Christian texts.  The triangulation strengthens, rather
than weakens, the observation: the abstract-noun and compound-noun
vocabulary of religious brotherhood (\grk{philadelphia},
\grk{pseudadelphos}, \grk{adelphot\=es}) crystallizes in exactly
the Hellenistic-Jewish and early-Christian milieu in which Paul
writes, not in the classical Greek from which the raw \grk{adelph-}
stem is inherited.
