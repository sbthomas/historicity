...
A further lexicographical observation worth recording: the
\grk{adelph-} family in Cambridge includes the adjective
\grk{phil-adelphos} (``brother-loving,'' cited from Xenophon,
Plutarch, Sophocles, and Polybius---strictly classical/Hellenistic
literary authors, with no NT citation), but does \textit{not}
include a separate headword for the abstract noun
\grk{philadelphia} (``brotherly love''), even though the editors
list the parallel abstract noun \grk{philandria} (``love of one's
husband'') on the same page.  The omission is a lexicographical
judgement, not an oversight.  It fits the attestation profile of
the word: while the adjective \grk{phil-adelphos} is well attested
in classical and Hellenistic Greek, the abstract noun
\grk{philadelphia} is essentially a first-century Christian
technical term---Paul uses it at Romans~12:10 and
1~Thessalonians~4:9, 1~Peter~1:22, 2~Peter~1:7, and Hebrews~13:1
make up most of the remaining NT occurrences, and its
pre-Christian attestations (Plutarch's
